...
Use the PR body template (`.github/pull_request_template.md`) in the style of [masterfabric_core#8](https://github.com/masterfabric-mobile/masterfabric_core/pull/8):

1. **Summary** — user-facing value  
2. **What changed** — bullet list  
3. **Architecture** — mermaid when flows change  
4. **End-to-end flows** — optional sequence  
5. **Test plan** — checklist  
6. **Merge target** — base/head branches  

Branch naming examples: `chore/bootstrap-from-masterfabric-go`, `feat/navgo-trip-api`, `feat/navgo-mcp-server`.
...
- Open a [Discussion](https://github.com/leventkok/NavGo-go/discussions)
- Check existing [Issues](https://github.com/leventkok/NavGo-go/issues)
